 ...
 */
                        /*************************/  /************************/
LIBNIFTI_EXPORT struct nifti_1_header { /* NIFTI-1 usage         */  /* ANALYZE 7.5 field(s) */
                        /*************************/  /************************/
 ...
 */
LIBNIFTI_EXPORT struct nifti1_extender { char extension[4] ; } ;
typedef LIBNIFTI_EXPORT struct nifti1_extender nifti1_extender ;

/*! \struct nifti1_extension
    \brief Data structure defining the fields of a header extension.
 */
LIBNIFTI_EXPORT struct nifti1_extension {
...
typedef LIBNIFTI_EXPORT struct nifti1_extension nifti1_extension ;
...
#if 0
typedef LIBNIFTI_EXPORT struct { float       r,i;     } complex_float ;
typedef LIBNIFTI_EXPORT struct { double      r,i;     } complex_double ;
typedef LIBNIFTI_EXPORT struct { long double r,i;     } complex_longdouble ;
typedef LIBNIFTI_EXPORTstruct { unsigned char r,g,b; } rgb_byte ;
#endif
